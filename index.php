...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            // Fetch all data from the database
            $sql = "SELECT handler, COUNT(*) AS count FROM encoded GROUP BY handler;";
            $result = $conn->query($sql);
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO encoded (handler, firstname, lastname, middlename, jobtitle) VALUES ('$handler', '$firstname', '$lastname', '$middlename', '$jobtitle')";
